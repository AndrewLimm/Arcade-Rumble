...
public class GameTetrisPieces : GameTetrisBaseTetrisPiece
{
    ...
    {
        // Soft drop movement
        if (Input.GetKey(KeyCode.S)) // Soft drop Player 1
        {
        ...
        // Left/right movement
        if (Input.GetKey(KeyCode.A)) // Move left Player 1
        {
            Move(Vector2Int.left);
        }
        else if (Input.GetKey(KeyCode.D)) // Move right Player 1
        {
