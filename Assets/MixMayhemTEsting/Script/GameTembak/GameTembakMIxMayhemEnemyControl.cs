...
public class GameTembakMIxMayhemEnemyControl : MonoBehaviour
{
    ...
    [SerializeField] GameTembakMixMayhemScoreManager scoreManagerGameTembak;

    void Awake()
    {
        // Temukan ScoreManagerGameTembak di scene
        scoreManagerGameTembak = FindObjectOfType<GameTembakMixMayhemScoreManager>();
