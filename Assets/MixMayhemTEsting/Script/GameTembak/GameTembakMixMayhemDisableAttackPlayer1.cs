...
public class GameTembakMixMayhemDisableAttackPlayer1 : MonoBehaviour
{
    public GameTembakMixMayhemPlayer1 player1Controller; // Referensi ke Player1Control
    private Coroutine disableCoroutine; // Menyimpan referensi ke coroutine yang berjalan

    private void Awake()
    {
        // Mencari Player1Control di scene
        player1Controller = FindObjectOfType<GameTembakMixMayhemPlayer1>();
