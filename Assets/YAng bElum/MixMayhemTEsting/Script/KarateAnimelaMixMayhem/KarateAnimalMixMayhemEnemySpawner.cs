...
public class KarateAnimalMixMayhemEnemySpawner : MonoBehaviour
{
    ...
    void SpawnTarget()
    {
        ...
        KarateANimalMixMayhemEnemySPeed enemyController = spawnedTarget.GetComponent<KarateANimalMixMayhemEnemySPeed>();
