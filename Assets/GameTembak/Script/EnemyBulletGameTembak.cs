...
public class EnemyBulletGameTembak : MonoBehaviour
{
    ...
    public void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            FindObjectOfType<GameControllerGameTembak>().OnPlayerHit("Player1");
        ...
        {
            FindObjectOfType<GameControllerGameTembak>().OnPlayerHit("Player2");
